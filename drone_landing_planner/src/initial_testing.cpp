...
int main(int argc, char **argv)
{
    ...
    auto take_off_action_client = rclcpp_action::create_client<payload_sdk_ros2_interfaces::action::TakeOff>(node, "/psdk_wrapper_node/takeoff_action");
    auto move_to_position_action_client = rclcpp_action::create_client<payload_sdk_ros2_interfaces::action::MoveToPosition>(node, "/psdk_wrapper_node/move_to_position_action");
    ...
    auto take_off_send_goal_options = rclcpp_action::Client<payload_sdk_ros2_interfaces::action::TakeOff>::SendGoalOptions();
    // take_off_send_goal_options.goal_response_callback = [](std::shared_future<rclcpp_action::ClientGoalHandle<payload_sdk_ros2_interfaces::action::TakeOff>::SharedPtr> future) {
    ...
    //     }
    // };
    take_off_send_goal_options.result_callback = [](const rclcpp_action::ClientGoalHandle<payload_sdk_ros2_interfaces::action::TakeOff>::WrappedResult &result) {
        switch (result.code) {
    ...
    auto move_to_position_goal = payload_sdk_ros2_interfaces::action::MoveToPosition::Goal();
    ...
    auto move_to_position_send_goal_options = rclcpp_action::Client<payload_sdk_ros2_interfaces::action::MoveToPosition>::SendGoalOptions();
